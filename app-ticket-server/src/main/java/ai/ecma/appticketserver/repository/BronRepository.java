...
//    List<Bron> findAllByTicketIdInAndUser(Collection<UUID> ticket_id, User user);
    List<Bron> findAllByTicketIdInAndUserAndBronStatusEnum(Collection<UUID> ticket_id, User user, BronStatusEnum bronStatusEnum);

//    List<Bron> findAllByTicketIdIn(Collection<UUID> ticket_id);
    List<Bron> findAllByTicketIdInAndBronStatusEnum(Collection<UUID> ticket_id, BronStatusEnum bronStatusEnum);
