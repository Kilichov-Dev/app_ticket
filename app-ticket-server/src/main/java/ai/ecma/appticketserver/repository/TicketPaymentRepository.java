...
//    Optional<TicketPayment> findFirstByTicketAndPayment_UserAndOrderTypeEnumOrderByCreatedAt(Ticket ticket, User payment_user, OrderTypeEnum orderTypeEnum);
    Optional<TicketPayment> findFirstByTicketAndPayment_UserAndReturnedsFalseAndOrderTypeEnumOrderByCreatedAtDesc(Ticket ticket, User payment_user, OrderTypeEnum orderTypeEnum);
