...
//                bron.getTicket().setStatusEnum(SeatStatusEnum.PAYMENT_PROCESS);
    ...
    public ApiResult<?> bookedTicketBuy(User user, TicketBuyDto ticketBuyDto) {
        ...
        List<Bron> bronList = bronRepository.findAllByTicketIdInAndUserAndBronStatusEnum(ticketBuyDto.getTicketIdList(), userTickets, BronStatusEnum.ACTIVE);
    ...
    public ApiResult<?> ticketBuy(User user, OrderPayDto orderPayDto) {
        ...
        List<Bron> bronList = bronRepository.findAllByTicketIdInAndBronStatusEnum(ticketIdSet, BronStatusEnum.ACTIVE);
